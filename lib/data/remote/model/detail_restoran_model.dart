...
class DetailRestoranModel extends Equatable {
  final bool error;
  final String message;
  final RestoranData restoran;
  ...
  factory DetailRestoranModel.fromJson(Map<String, dynamic> json) =>
      DetailRestoranModel(
        error: json['error'],
        message: json['message'],
        restoran: RestoranData.fromJson(json['restaurant']),
      );
}

class RestoranData extends Equatable {
  final String id;
  final String name;
